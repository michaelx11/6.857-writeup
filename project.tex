...
\begin{figure}[H]
  \caption{Figure 3: the output of our filtering algorithm when applied to the decompiled Snapchat code.}
  \centering
...
\begin{figure}[H]
  \caption{Figure 4: part of the source code of the file "NotificationReciever", where we found those strange strings}
  \centering
